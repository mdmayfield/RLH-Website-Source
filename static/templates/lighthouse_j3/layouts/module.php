...
if ($style == '') {
	...
	if ($module->position == 'innertop-a') $style = 'box';
	if ($module->position == 'innertop-b') $style = 'box';
	if ($module->position == 'innerbottom-a') $style = 'box';
	if ($module->position == 'innerbottom-b') $style = 'box';
...
if (in_array($module->position, array('headerbar', 'toolbar-r' ,'toolbar-l', 'footer', 'bottom-d'))) {
	$style = '';
	$showtitle = 0;
}
...
if ($module->menu) {
	...
	if (isset($params['menu'])) {
		...
		$renderer = 'dropdown';
	} else if (in_array($module->position, array('toolbar-l', 'toolbar-r', 'footer', 'bottom-d', 'bottom-menu'))) {
		$renderer = 'default';
	} else {
		$renderer = 'accordion';
	}
